...
Dialog::Dialog(QWidget *parent)
    ...
    , requestLineEdit(new QLineEdit(tr("020005C1400000008603")))
...
void Dialog::transaction()
{
    ...
    qDebug() << requestLineEdit->text();
    QByteArray qba;
    QByteArray text = QByteArray::fromHex(qba.append(requestLineEdit->text()));
    qDebug() << "hex text:" <<text.data();
